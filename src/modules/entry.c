...
//modified by yulw
 //Now i don't need the debug info.
...
#define _RC_DEBUG_FILE_NAME  "D://TEST//rclog_entry.txt"
...
{
    //yulw modified: add log

    module_t **pprimary = (module_t **)plugin;
    module_t *module = (module_t *)tgt;
    module_config_t *item = (module_config_t *)tgt;
    RC_DEBUG_ENCODE_MESSAGE("%s, property_id: %d\n","steping into plugin_setting.",propid);
    ...
    switch (propid)
    {
        case VLC_MODULE_CREATE:
        {
            ...
            *(va_arg (ap, module_t **)) = submodule;
            ...
            RC_DEBUG_ENCODE_MESSAGE("setting plugin: %s: %d\n",submodule->psz_longname,propid);
        ...
        case VLC_MODULE_CB_OPEN:
            ...
            RC_DEBUG_ENCODE_MESSAGE("VLC_MODULE_CB_OPEN: %s\n",module->psz_longname);

            break;

        case VLC_MODULE_CB_CLOSE:

            RC_DEBUG_ENCODE_MESSAGE("VLC_MODULE_CB_CLOSE: %s\n",module->psz_longname);
        ...
        case VLC_MODULE_NO_UNLOAD:
            ...
            RC_DEBUG_ENCODE_MESSAGE("VLC_MODULE_NO_UNLOAD: %s\n",module->psz_longname);
