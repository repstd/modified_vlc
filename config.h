...
#define CONFIGURE_LINE "./configure  '--host=i586-mingw32msvc' '--disable-taglib' '--disable-gnutls' '--disable-sse' '--disable-mmx' '--disable-dxav2' '--disable-neon' '--disable-x265' '--disable-vlm' '--disable-dxva2' 'host_alias=i586-mingw32msvc' 'PKG_CONFIG_LIBDIR=/root/msvc/vlc-2.0.6/contrib/i586-mingw32msvc/lib/pkgconfig'"
...
#define PACKAGE_STRING "vlc 2.0.6"
...
#define VERSION_MESSAGE "2.0.6 Twoflower"

/* compiler */
#define VLC_COMPILER "gcc version 4.2.1-sjlj (mingw32-2)"
