...
inline void MainInterface::showTab( QWidget *widget )
{
    ...
    //yulw mofify
    if(THEMIM->getIM()->playingStatus()==END_S)
    {
        //stackCentralOldWidget = stackCentralW->currentWidget();

          videoWidget->show(); 
        stackCentralW->setCurrentWidget( bgWidget );
       b_interfaceFullScreen =true;
        //setStatusBarVisibility(false);
      setWindowState(Qt::WindowFullScreen);
...
void MainInterface::setVLCWindowsTitle( const QString& aTitle )
{
    ...
    {
        //yulw modified
        setWindowTitle( qtr( "MediaEntertainmentSystem" ) );
    }
    else
    {
        setWindowTitle( aTitle + " - " + qtr( "MediaEntertainmentSystem" ) );
    }
}
...
void MainInterface::createSystray()
{
    ...
    sysTray->setToolTip( qtr( "MediaEntertainmentSystem" ));

    systrayMenu = new QMenu( qtr( "MediaEntertainmentSystem" ), this );
                                    ...
                                    QSystemTrayIcon::ActivationReason reason )
{
    switch( reason )
    {
        ...
        case QSystemTrayIcon::MiddleClick:
            sysTray->showMessage( qtr( "MediaEntertainmentSystem" ),
...
void MainInterface::updateSystrayTooltipName( const QString& name )
{
    ...
    else
    {
        ...
        {
            sysTray->showMessage( qtr( "MediaEntertainmentSystem" ), name,
